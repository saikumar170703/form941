            ...
            <div class="col-lg-6 login-right-form">
                <div class="login-box">
                    ...
                    <form action="<%= request.getContextPath() %>/login" method="POST" id="loginForm">
                        ...
                        <form action="<%= request.getContextPath() %>/auth/google/register" method="POST" id="googleLoginForm">
                            <input type="hidden" name="googleEmail" id="googleEmailLoginInput">
                            <input type="hidden" name="googleName" id="googleNameLoginInput">
                            <button type="button" class="btn btn-outline-secondary w-100 py-2 rounded-3 fw-bold d-flex align-items-center justify-content-center gap-2 shadow-sm" onclick="openGoogleOAuthPopupWindow()" style="border-color: #D1D5DB; background: #FFFFFF; color: #374151;">
